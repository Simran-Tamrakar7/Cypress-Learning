describe("Forex Deal Automation", () => {
  it("fills and submits the Forex deal form", () => {
    ...
    cy.contains("span", "Treasury Deal Creation", { timeout: 1000 }).should("be.visible");
    ...
    cy.get("div.ant-select-item-option")
      .contains("AED")
      .click({ force: true });
    ...
    // cy.get("#counterPartyId").click().type("123{enter}");
    ...
    // --- Upload file ---
    // const filePath = "Cypress/fixtures/Screenshot_2025-07-25.png"; // save your file in fixtures folder
